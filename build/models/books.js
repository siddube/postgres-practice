...
var BookStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not get books. Error: " + err_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not get books. Error: " + err_2);
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    BookStore.prototype.create = function (b) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, book, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, conn.query(sql, [b.title, b.author, b.total_pages, b.type])];
                    case 2:
                        result = _a.sent();
                        book = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not get books. Error: " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not get books. Error: " + err_4);
                    case 4: return [2 /*return*/];
                }
            });
        });
